...
#'
#' @return AllEvents_RNASeq_MP object contains all the detected alternative
...
#' in the \code{SGSeq} R package vignette.
#'
#' @format A \code{list} object \code{AllEvents_RNASeq[[i]][[j]]}
