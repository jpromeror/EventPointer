...
## Event From Transcriptome Reference
...
![**Figure 8.** Multi-Path alternative splicing events for EventPointer ](Figure10.png)
...
![**Table 5.** Coefficients of the linear model used to detect alternative splicing ](Figure9.png)
