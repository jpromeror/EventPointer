...
# Run the function
   ...
   CDFfromGTF(input="GTF",inputFile=DONSON_GTF,
              PSR=PSRProbes,Junc=JunctionProbes,PathCDF=Directory)
...
```{r PrepareBam, eval=TRUE, collapse=TRUE}
