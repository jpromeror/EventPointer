...
The following code chunk displays the pipeline used. It may be modified to use different methods, but the output must remain the same.

```{r, eval=FALSE}

# Aroma.Affymetrix Preprocessing Pipeline
